...
void MixMonsterScene::setupControlPanel()
{
    needToReset = false;
...
bool MixMonsterScene::isAncestor(int ancestor, int child) {
    int cur = child;
...
vector<int> MixMonsterScene::getNonChildren(int ancestor)
{
...
int MixMonsterScene::getRandomNonChild(int i)
{
...
void MixMonsterScene::attach(int child, int parent)
{
    treeSwap[child] = parent;
}

void MixMonsterScene::update()
{
    ofMatrix4x4 mat;
...
void MixMonsterScene::onPanelChanged(ofxUIEventArgs &e)
{
...
void MixMonsterScene::drawActor(const ramActor& actor)
{
    
}

void MixMonsterScene::drawRigid(const ramRigidBody &rigid)
{
    
}

void MixMonsterScene::onActorSetup(const ramActor &actor)
{
    
}

void MixMonsterScene::onActorExit(const ramActor &actor)
{
    
}

void MixMonsterScene::onRigidSetup(const ramRigidBody &rigid)
{
    
}

void MixMonsterScene::onRigidExit(const ramRigidBody &rigid)
{
