...
void GearShapeDrawer::drawCoordSystem()  {
	glBegin(GL_LINES);
	glColor3f(1, 0, 0);
	glVertex3d(0, 0, 0);
	glVertex3d(1, 0, 0);
...
void GearShapeDrawer::drawSphere(btScalar radius, int lats, int longs) 
{
	int i, j;
	for(i = 0; i <= lats; i++) {
...
void GearShapeDrawer::drawCylinder(float radius,float halfHeight, int upAxis)
{
...
GearShapeDrawer::ShapeCache*		GearShapeDrawer::cache(btConvexShape* shape)
{
...
void GearShapeDrawer::drawOpenGL(btScalar* m, const btCollisionShape* shape, const btVector3& color)
{
    drawOpenGL(m, shape, color, 0, btVector3(), btVector3());
}

void GearShapeDrawer::drawShadow(btScalar* m, const btVector3& extrusion, const btCollisionShape* shape)
{
    drawShadow(m, extrusion, shape, btVector3(), btVector3());
}

void GearShapeDrawer::drawOpenGL(btScalar* m, const btCollisionShape* shape, const btVector3& color,int	debugMode,const btVector3& worldBoundsMin,const btVector3& worldBoundsMax)
{
...
//
void		GearShapeDrawer::drawShadow(btScalar* m,const btVector3& extrusion,const btCollisionShape* shape,const btVector3& worldBoundsMin,const btVector3& worldBoundsMax)
{
	glPushMatrix(); 
	//btglMultMatrix(m);
    glMultMatrixf(m);
...
//
GearShapeDrawer::GearShapeDrawer()
{
	m_texturehandle			=	0;
